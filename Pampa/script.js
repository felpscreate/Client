/**
 * PAMPA DOG - script.js
 * Carousel, navegação, scroll reveal e interações
 */
...
// ============================================================
// PEDIR AGORA BUTTONS — analytics-ready click handler
// ============================================================
function initOrderButtons() {
  document.querySelectorAll('[data-action="pedido"]').forEach(btn => {
    btn.addEventListener('click', function () {
      ...
      // Aqui você pode adicionar rastreamento de eventos (Google Analytics, etc.)
    });
  });
}
...
function addWhatsappFloat() {
  ...
  btn.id = 'wpp-float';
  btn.href = 'https://wa.me/5500000000000'; // ← substitua pelo número real
  btn.target = '_blank';
